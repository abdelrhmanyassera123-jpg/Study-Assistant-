...
- "start" و "end": الوقت بنظام 24 ساعة "HH:MM". لو الوقت مكتوب 10-12 يبقى start "10:00" و end "12:00". لو مفيش وقت نهاية سيب "end" فاضية.
  **جداول فيها أعمدة زمن كل نص ساعة (9:30، 10:00، 10:30...) دي مسطرة وقت، مش مدة المحاضرة لوحدها — خلية المحاضرة بتمتد فوق كذا عمود منها.** اتبع الخطوات دي بالظبط لكل محاضرة قبل ما تحدد وقتها:
  1. اقرا عناوين كل أعمدة الوقت فوق الجدول بالترتيب من الشمال لليمين، عمود عمود، من غير ما تقفز أي واحد فيهم.
  2. لو فيه عمود اسمه "استراحة/Break" أو "توافر الدكتور/Lecturer availability" وسط الأعمدة دي، ده عمود حقيقي وله مكانه في الترتيب برضو — مترجّعهوش كمحاضرة، لكن خُده في الحسبان وانت بتعد الأعمدة عشان الأعمدة اللي بعده متتزحزحش مكان.
  3. شوف خلية المحاضرة بتاخد كام عمود من الأعمدة دي جنب بعض (حدودها بلونها أو تكرار نفس النص جواها).
  4. "start" = بداية أول عمود لمسته الخلية، و"end" = نهاية آخر عمود لمسته — مش أول عمود بس، ومش تخمين بالنظر لطول الخلية.
  5. **ممنوع يدخل عمود "استراحة" أو "توافر الدكتور" في مدة أي محاضرة تانية جنبه**، سواء قبلها أو بعدها. لو المحاضرة السابقة أو التالية لمحاضرتك بتلمس عمود من دول، وقف "end"/ابدأ "start" عند حدود آخر عمود حقيقي فيه اسم المادة نفسها، مش عند حدود العمود الفاضي اللي جنبه.
     مثال: الأعمدة بالترتيب [9:30-10:00][10:00-10:30] فيهم مادة X، وبعدهم [10:30-11:00] "توافر الدكتور"، وبعده [11:00-11:30][11:30-12:00] فيهم مادة Y. الصح: X = "09:30"-"10:30"، وY = "11:00"-"12:00". **الغلط الشائع**: X = "09:30"-"11:00" (بلع عمود التوافر) أو Y = "10:30"-"12:00" (بدأها من عمود التوافر).
  **فحص اتساق الوقت**: محاضرتين مختلفتين (عنوان مختلف) لنفس القسم في نفس اليوم متينفعش ياخدوا نفس الوقت بالظبط، إلا لو فعلاً موازيين ومكتوبين في نفس الخلية (زي "Skill a"/"Skill b"). لو رجّعت كده، يبقى في غلط في عدّ الأعمدة — ارجع اتأكد من الأعمدة وصحّحه قبل ما ترجّع الرد.
