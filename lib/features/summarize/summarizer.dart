...
{"groups":[],"group_label":"","note":"","time_columns":[],"entries":[{"title":"","day":"","start":"","end":"","location":"","lecturer":"","group":""}]}

- "time_columns": **املأ الحقل ده الأول قبل أي حاجة تانية، حتى قبل "entries".** لو الجدول فيه أعمدة زمن ثابتة فوقه (زي 9:30-10:00، 10:00-10:30، 10:30-11:00...)، اقرا عناوينها كلها بالترتيب من الشمال لليمين وارجعها زي ما هي مكتوبة بالظبط، عمود عمود من غير ما تقفز أي واحد. لو في عمود اسمه "استراحة/Break" أو "توافر الدكتور/Lecturer availability" وسط الأعمدة دي، سيبه في مكانه في المصفوفة بنفس اسمه (مش وقت) — هو عمود حقيقي وله مكانه في الترتيب. لو الجدول مفهوش أعمدة زمن ثابتة أصلاً (كل محاضرة وقتها مكتوب جنبها مباشرة)، سيب "time_columns" فاضية.
  **"time_columns" هو المرجع الوحيد اللي هتحسب منه وقت كل محاضرة بعد كده — مش تخمين منفصل لكل صف.**
...
- "start" و "end": الوقت بنظام 24 ساعة "HH:MM". لو الوقت مكتوب 10-12 يبقى start "10:00" و end "12:00". لو مفيش وقت نهاية سيب "end" فاضية.
  لو ملأت "time_columns"، احسب وقت كل محاضرة بالرجوع ليها بس: شوف خلية المحاضرة بتلمس كام عنصر من "time_columns" جنب بعض (حدودها بلونها أو تكرار نفس النص جواها)، و"start" = بداية أول عنصر لمسته، و"end" = نهاية آخر عنصر لمسته.
  **ممنوع يدخل عنصر "استراحة" أو "توافر الدكتور" من "time_columns" في مدة أي محاضرة جنبه**، سواء قبلها أو بعدها — وقف "end"/ابدأ "start" عند حدود آخر عنصر حقيقي فيه اسم المادة نفسها، مش عند حدود العنصر الفاضي اللي جنبه.
  مثال: "time_columns" = ["09:30-10:00","10:00-10:30","توافر الدكتور","11:00-11:30","11:30-12:00"]، ومادة X مكتوبة في أول عنصرين ومادة Y في آخر عنصرين. الصح: X = "09:30"-"10:30"، وY = "11:00"-"12:00". **الغلط الشائع**: X = "09:30"-"11:00" (بلعت عنصر التوافر) أو Y = "10:30"-"12:00" (بدأها من عنصر التوافر).
  **فحص اتساق الوقت**: محاضرتين مختلفتين (عنوان مختلف) لنفس القسم في نفس اليوم متينفعش ياخدوا نفس الوقت بالظبط، إلا لو فعلاً موازيين ومكتوبين في نفس الخلية (زي "Skill a"/"Skill b"). لو رجّعت كده، ارجع لـ "time_columns" وصحّح العدّ قبل ما ترجّع الرد.
...
- **الجدول ممكن يبقى فيه عمود قسم بمستويين مكتوبين مع بعض**: حرف رئيسي (A-F)، وتحته أو جنبه أرقام فرعية ثابتة لكل حرف (زي G1-G18، حرف A بياخد G1..G3 مثلاً، B بياخد G4..G6، وهكذا). **قاعدة صارمة لو شفت الشكل ده**: كل محاضرة تحت القسم ده — نظري كانت أو عملي أو سيمينار — لازم "group" بتاعها يحتوي الحرف والرقم مع بعض بالصيغة "الحرف-الرقم" (مثلاً "A-G1")، **حتى لو المحاضرة النظرية مكتوبة في خلية واحدة مشتركة بين كل أرقام الحرف** (يبقى وقتها ارجعها كذا صف — صف لكل رقم فرعي تحت الحرف، كل صف بتاجه "الحرف-رقمه" — مش صف واحد بتاج الحرف لوحده). **ممنوع تمامًا** ترجع "group":"A" لوحدها، أو "group":"G1" لوحدها، في الحالة دي — لو رجّعت أي محاضرة بحرف لوحده أو رقم لوحده وهما مكتوبين في الجدول كمستويين، يبقى في غلط ولازم تصلحه قبل ما ترجّع الرد. المستوى الواحد بس (حرف لوحده أو رقم لوحده، من غير المستوى التاني موجود في الجدول أصلاً) هو اللي بيترجع لوحده.
