...
- **الجدول ممكن يبقى فيه تقسيم على مستويين** (زي حرف قسم رئيسي A-F، وتحته أرقام فرعية لمجموعات أصغر لكل معمل أو سيمينار). في الحالة دي رجّع القسم **الرئيسي** بس (الحرف)، ومتحطش الأرقام الفرعية في "groups" — هي مش اللي الطالب بيحدد بيها نفسه غالبًا.
