  ...
  static String scheduleEntriesSystem({
    ...
    final timeGuidance = timeColumns.isEmpty
        ...
        : 'احسب وقت كل محاضرة بالرجوع لأعمدة الوقت المؤكدة فوق بس: شوف خلية '
            ...
            '  **ممنوع يدخل عمود "استراحة" أو "توافر الدكتور" في مدة أي '
            'محاضرة جنبه**، سواء قبلها أو بعدها — وقف "end"/ابدأ "start" '
            'عند حدود آخر عمود حقيقي فيه اسم المادة نفسها، مش عند حدود '
            'العمود الفاضي اللي جنبه.\n'
