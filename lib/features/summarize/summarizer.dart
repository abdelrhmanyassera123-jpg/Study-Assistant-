...
{"time_columns":[],"groups":[],"group_label":"","note":""}
...
''';
  ...
  static String scheduleEntriesPrompt(String text) {
    const task = 'التركيب (الأعمدة والأقسام) معروف ومؤكد بالفعل زي ما اتقالك. '
