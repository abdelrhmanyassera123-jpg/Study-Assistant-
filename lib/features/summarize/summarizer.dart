...
{"day_start":"","day_end":"","slot_minutes":0,"days":[],"groups":[],"group_label":"","note":""}

- "day_start" و"day_end": لو الجدول فيه شريط أعمدة وقت منتظم فوقه (زي 9:30-10:00، 10:00-10:30، 10:30-11:00... كل عمود نفس الطول)، اكتب أول وقت يبدأ بيه الشريط ("day_start") وآخر وقت ينتهي بيه ("day_end") بنظام 24 ساعة "HH:MM" (زي "09:30" و"16:00"). دي بس أرقام الوقت — متكتبش فيها كلمة "استراحة" ولا "توافر الدكتور" ولا أي نص تاني.
- "slot_minutes": طول العمود الواحد بالدقايق (غالبًا 30). لو الشريط مش منتظم الطول، أو مفيش شريط وقت ثابت أصلاً (كل محاضرة وقتها مكتوب جنبها مباشرة)، سيب "day_start" و"day_end" فاضيين و"slot_minutes" صفر.
