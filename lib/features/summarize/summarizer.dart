...
- **الجدول ممكن يبقى فيه تقسيم على مستويين**: حرف قسم رئيسي (A-F) بيحدد قاعة المحاضرات النظرية، وتحته أرقام فرعية (زي G1-G18) بتحدد **معاد** كل مجموعة صغيرة في العملي والسيمينار — المجموعات الفرعية دي مش بس تصنيف، وقتها بيختلف فعلاً عن بعضها. **متلزقش الفرعي في الرئيسي**: لو المحاضرة النظرية بتتحدد بالحرف بس (كل المجموعات الفرعية تحته في نفس القاعة والوقت)، رجّع الحرف. لو العملي/السيمينار بيختلف معاده باختلاف الرقم الفرعي، رجّع **الاتنين مع بعض** زي ما هما مكتوبين (مثلاً "A-G1" أو "G1") عشان كل رقم فرعي يفضل معاده منفصل عن التاني، ومترجّعش كل أرقام الحرف الواحد كأنهم بمعاد واحد.
